...
window.ZP_CONFIG = {
  ...
  t: {
    pl: {
      ...
      bigGroup: "Grupy powyżej 12 osób obsługujemy jako rezerwacje grupowe — zadzwoń: 573 569 141 albo skorzystaj z formularza cateringowego.",
      ...
      sendError: "Nie udało się wysłać formularza. Spróbuj ponownie albo zadzwoń: 573 569 141.",
    ...
    en: {
      ...
      bigGroup: "Groups larger than 12 are handled as group bookings — call 573 569 141 or use the catering enquiry form.",
      ...
      sendError: "The form could not be sent. Try again or call 573 569 141.",
