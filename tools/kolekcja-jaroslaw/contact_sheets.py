...
Bierze GOTOWE pliki wynikowe (assets/kolekcja/img_jaroslaw), czyli to, co zobaczy
odbiorca strony."""
import os, math
from PIL import Image, ImageDraw, ImageFont

ROOT = '/home/user/radosc-website-preview'
SRC = os.path.join(ROOT, 'assets', 'kolekcja', 'img_jaroslaw')
OUT = os.path.join(ROOT, '.work-jar', 'sheets')
