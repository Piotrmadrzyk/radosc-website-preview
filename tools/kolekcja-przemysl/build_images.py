# -*- coding: utf-8 -*-
"""Generuje pliki wynikowe galerii z NIEOBRÓCONYCH oryginałów w .work-prz/orig.

Idempotentny z definicji: źródłem jest zawsze nietknięta migawka .work-prz/orig,
a obrót brany jest z rotations.json. Dwukrotne uruchomienie daje ten sam wynik.

rotations.json: { "pt-1-9-a": 90, ... } — stopnie ZGODNIE Z RUCHEM WSKAZÓWEK ZEGARA,
...
ORIG = os.path.join(ROOT, '.work-prz', 'orig')
ROT = os.path.join(ROOT, '.work-prz', 'rotations.json')
