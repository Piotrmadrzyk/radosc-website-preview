# -*- coding: utf-8 -*-
"""Generuje pliki wynikowe galerii z NIEOBRÓCONYCH oryginałów w .work/orig.

Idempotentny z definicji: źródłem jest zawsze nietknięta migawka .work/orig,
a obrót brany jest z rotations.json. Dwukrotne uruchomienie daje ten sam wynik.

rotations.json: { "pt-7-1-a": 90, ... } — stopnie ZGODNIE Z RUCHEM WSKAZÓWEK ZEGARA,
...
THUMB = os.path.join(ROOT, 'assets', 'kolekcja', 'thumbs_warszawa')
