...
Bierze GOTOWE pliki wynikowe (assets/kolekcja/img_warszawa), czyli to, co zobaczy
odbiorca strony."""
import os, math
from PIL import Image, ImageDraw, ImageFont

ROOT = '/home/user/radosc-website-preview'
SRC = os.path.join(ROOT, 'assets', 'kolekcja', 'img_warszawa')
OUT = os.path.join(ROOT, '.work', 'sheets')
